...
- (id<UIViewControllerAnimatedTransitioning>)animationControllerForPresentedController:(UIViewController *)presented presentingController:(UIViewController *)presenting sourceController:(UIViewController *)source {
    isPresented = YES;
    [[NSNotificationCenter defaultCenter] postNotificationName:VVS_POPOVER_ANIMATION_DID_PRESENTED_NOTIFICATION object:self userInfo:nil];
    return self;
}
/**
 告诉系统谁来负责转场如何消失
...
- (id<UIViewControllerAnimatedTransitioning>)animationControllerForDismissedController:(UIViewController *)dismissed {
    isPresented = NO;
    [[NSNotificationCenter defaultCenter] postNotificationName:VVS_POPOVER_ANIMATION_DID_DISMISSED_NOTIFICATION object:self userInfo:nil];
    return self;
}
